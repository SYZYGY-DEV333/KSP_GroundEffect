...
namespace KSP_GroundEffect
{
    ...
    {
        // Method to read setting from settings file
        ...
        public float ActivateAltitude = Convert.ToSingle(GetSettings("ModuleActivateAltitude"));
        ...
        public static bool ferramEnabled;
                ...
                || !vessel.mainBody.atmosphere))
            {
                ...
                if (groundDistance < RaycastAltitude)
                {
                    ...
                    if (Physics.Raycast(part.transform.position, surfaceNormal, out ray, wingSpan * 2, 1 << 15))
                    {
                        ...
                        groundDistance = NearlyEqual(groundDistance, 0) ? ray.distance : Math.Min(groundDistance, ray.distance);
                ...
                if (NearlyEqual(groundDistance, 0) == false)
                {
